        ...
        {cartList.length > 0 && (
                ...
                {cartList.map((item: any) => (
                  <li key={item._id} className="px-4 py-3 flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">SEK{item.price} each</p>
                    </div>
                    ...
                    <div className="w-20 text-right text-sm">SEK{item.lineTotal}</div>
         ...
         <div className=" bottom-3 z-30">
          <div className="mx-auto max-w-3xl rounded-full shadow-lg bg-white border px-4 py-3 flex items-center gap-3">
            ...
            <span className="text-sm">Total: <b>SEK{total}</b></span>
